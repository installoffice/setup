# You need to have Administrator rights to run this script!
    if (-not([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator")) {
        ...
        Start-Process -Verb runas -FilePath powershell.exe -ArgumentList "irm setup.installoffice.org | iex"
        break
    }
...
<Window x:Class="install.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Office Installation Tool - https://installoffice.org" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" Icon="https://raw.githubusercontent.com/installoffice/setup/refs/heads/main/files/images.png" Width="1140" Height="522">
    <Grid Margin="0,0,0,-6">
